        ...
        return (
                <div className={`bg-transparent p-3 rounded-lg text-sm flex ${className}`}>
                        <div className="w-1/2">
                                ...
                                <input id={amountInputId} className="outline-none w-full bg-transparent py-1.5" type="number" placeholder="Amount" disabled={amountDisable} value={amount} onChange={(e) => onAmountChange && onAmountChange(Number(e.target.value))}></input>
                        </div>
